...
var Login = (function () {
    ...
    Login.authenticate = function (request, response) {
                    ...
                    if (!util.isNullOrUndefined(result)) {
                        ...
                        sessionCollection.insertOne(sessionData, function (err3, result3) {
                            if (util.isNullOrUndefined(err3)) {
                                ...
                                User.getPermissionsByUserId(result._id.toString(), function (result4) {
    ...
    Login.authenticateFromMobile = function (request, response) {
    ...
    Login.check = function (request, response, complete) {
    ...
    Login.checkForAjax = function (request, response) {
        var sessionId = request.session.sessionId;
        if (util.isNullOrUndefined(sessionId)) {
