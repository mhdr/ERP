...
router.post("/Login/Authenticate", function (request, response, next) {
    Login.authenticate(request, response);
});
router.post("/User/GetUserIP", function (request, response, next) {
    IP.getIP(request, response);
});
router.post("/User/GetLastLogin", function (request, response, next) {
    User.getLastLoginIP(request, response);
});
router.post("/User/GetUser", function (request, response, next) {
