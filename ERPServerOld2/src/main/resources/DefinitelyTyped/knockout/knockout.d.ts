...
interface KnockoutBindingHandlers {
    ...
    fadeIn:KnockoutBindingHandler;
    slideInRight:KnockoutBindingHandler;
    injectLoaderHTML:KnockoutBindingHandler;

    // #Users
    changeTableRowClassOnSelect:KnockoutBindingHandler;
}
